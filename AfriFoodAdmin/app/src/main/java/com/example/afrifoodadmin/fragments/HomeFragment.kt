...
import com.example.afrifoodadmin.activity.AllOrderActivity
import com.example.afrifoodadmin.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.button3.setOnClickListener{
            findNavController().navigate(R.id.action_homeFragment_to_addaccompanimentFragment4)
        }
        ...
        binding.button5.setOnClickListener{
            findNavController().navigate(R.id.action_homeFragment_to_addstoreFragment)
        }
